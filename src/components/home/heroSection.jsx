import xericsDashboard from '@/assets/images/xericsDashboard.png';
...
const HeroSection = () => {
  return (
    <div className="text-center lg:px-18 lg:py-14 py-14 md:pt-20 md:pb-56 px-4">
      ...
      <button className="btn btn-base bg-blue-500 hover:bg-blue-700 text-base-100 capitalize">Get Started <i className="pi pi-arrow-right"></i></button>
      <div 
        className="lg:mx-auto lg:w-3/4 md:left-28 lg:mt-14 w-full lg:h-[500px] h-64 bg-contain bg-no-repeat lg:bg-cover bg-center rounded-lg" 
